...
class JobsViewController extends CommonController
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $functionrepo = $em->getRepository('App:FunctionEntity');
        ...
        $functions = $functionrepo->findAllActive();
    ...
    public function jobsAction(Request $request)
    {
        ...
        $so_repo = $em->getRepository('App:ShiftOrganization');
    ...
    public function stateAction(Request $request, Job $job, $state, $access)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        if ($job->isBooked() && $overlap = $em->getRepository('App:Job')->checkOverlapForPerson($job, array('booked' => true))) {
