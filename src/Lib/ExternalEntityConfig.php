...
class ExternalEntityConfig
{
    ...
    public static function getTypesFor($thingie, $type)
    {
        ...
        return self::$types[$thingie][$type] ?? array();
    }
    ...
    {
        return self::$states[$thingie]['states'] ?? self::$states['default']['states'];
    }
    ...
    {
        return self::$states[$thingie]['active_states'] ?? self::$states['default']['active_states'];
    }

    public static function getAvailableStatesFor($thingie)
    {
        return self::$states[$thingie]['available_states'] ?? self::$states['default']['available_states'];
    }

    public static function getWishlistStatesFor($thingie)
    {
        return self::$states[$thingie]['wishlist_states'] ?? self::$states['default']['wishlist_states'];
    }
    ...
    {
        return self::$states[$thingie]['done_states'] ?? self::$states['default']['done_states'];
    }

    public static function getEnableLoginStatesFor($thingie)
    {
        return self::$states[$thingie]['enable_login'] ?? self::$states['default']['enable_login'];
    }
